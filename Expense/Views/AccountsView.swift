    ...
    var body: some View {
        NavigationView {
            ...
            .toolbar {
                ...
                ToolbarItem(placement: .navigationBarTrailing) {
                    AddAccountMenu(
                        ...
                        showingAddCreditCard: $showingAddCreditCard
                    )
                }
            }
            .refreshable {
            ...
            .sheet(item: $selectedAccount) { account in
                ...
                } else if account.accountType == AccountType.creditCard.rawValue {
                    EditCreditCardView(viewModel: viewModel, account: account)
                } else {
            ...
            .sheet(isPresented: $showingAddCreditCard) {
...
private struct AddAccountMenu: View {
    ...
    @Binding var showingAddCreditCard: Bool
    @State private var selectedAccountType: AccountType?
